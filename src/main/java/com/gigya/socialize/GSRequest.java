...
public class GSRequest {
	 ...
	 *
	 * @param apiKey
	 *            your Gigya API-Key which can be obtained from the <a href=
	 ...
	 *            >Site Setup</a> guide).
	 * @param secretKey
	 *            your Gigya Secret-Key which can be obtained from the <a href=
	 *            "https://www.gigya.com/site/partners/settings.aspx#&amp;&amp;userstate=SiteSetup"
	 *            >Site Setup</a> page on Gigya's website.
	 * @param apiMethod
	 *            the Gigya API method to call, including namespace. For
	 ...
	 * @param clientParams
	 *            a GSObject object that contains the parameters for the Gigya
	 ...
	 * @param useHTTPS
	 *            this parameter determines whether the request to Gigya will be
	 ...
	 * @param userKey
	 *            A key of an administrative user with extra permissions.
	...
	*/
	 ...
	 *            key with which the specified value is to be associated
	 * @param value
	 *            a GSObject value to be associated with the specified key
	 */
	 ...
	 *            key with which the specified value is to be associated
	 * @param value
	 *            a GSArray value to be associated with the specified key
	 */
	 ...
	 *
	 * @param timeoutMS
	 *            using this parameter you may set a timeout to this request.
	 ...
	 *
	 * @param listener
	 *            an Object which implements the GSResponseListener
	 */
	 ...
	 *            an Object which implements the GSResponseListener
	 * @param context
	 *            this object will be passed untouched and received back in the
	 *            response
	 */
