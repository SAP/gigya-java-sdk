...
/**
 * GSAuthUtils - Authentication utilities for JWT and signature validation.
 * Consolidated from GSAuthRequestUtils for unified GSRequest.
 */
public class GSAuthUtils {
     ...
     * @return Generated public key instance.
     */
    public static PublicKey rsaPublicKeyFromJWKString(String jwk) {
        try {
            // JWK to json.
    ...
    private static String attemptValidation(String jwt, String apiKey, String apiDomain) {
        ...
        PublicKey publicKey = GSAuthUtils.rsaPublicKeyFromJWKString(publicJWK);
        if (publicKey == null) {
     ...
     */
    public static String getKidFromJWSHeader(String jws) {
     ...
     * 
     * Note: This method creates a temporary GSRequest to avoid circular dependency.
     * It uses basic authentication with only apiKey for anonymous access.
     *
     ...
     */
    public static String fetchPublicJWK(String kid, String apiKey, String apiDomain) {
        // Create basic config for anonymous request
        GSConfig tempConfig = GSConfig.create().setApiKey(apiKey).setApiDomain(apiDomain);
        
        // Create anonymous request for fetching public key
        GSRequest request = new GSRequest(tempConfig);
        request.setMethod("accounts.getJWTPublicKey");
     ...
     */
    public static String verifyJwt(String jwt, String apiKey, PublicKey key) {
        try {
